...
if(isset($_SESSION['is_adminlogin'])){
 ...
 if(isset($_REQUEST['assign'])){
  ...
  ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") ||
   ...
   $rno = rand(1000000,9999999);
   $sql = "INSERT INTO assignwork_tb (rno, request_id, request_info, request_desc, requester_name, requester_add1, 
   requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, 
   assign_tech, assign_date) VALUES ($rno, $rid, '$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip', '$remail', '$rmobile', '$rassigntech', '$rdate')";
   if($conn->query($sql) == TRUE){
...
<div class="col-sm-5 mt-5 jumbotron"> <!-- Start Assigned Work 3rd Column-->
 <form action="" method="POST">
   ...
   <div class="form-row">
      ...
      <div class="form-row">
      <div class="form-group col-md-6">
        <label for="assigntech">Technician Email</label>
        <input type="text" class="form-control" id="assigntech-email" name="assigntech-email">
      </div>
      <div class="form-group col-md-6">
