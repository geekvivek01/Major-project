...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php 
   ...
   $sql = "SELECT * FROM requestlogin_tb WHERE r_login_id = {$_REQUEST['id']}";
   ...
   if(isset($_REQUEST['requpdate'])){
    if(($_REQUEST['r_login_id'] == "") || ($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "")){
     ...
     $sql = "UPDATE requestlogin_tb SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail' WHERE r_login_id = '$rid'";
