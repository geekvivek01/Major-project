...
<div class="col-sm-9 col-md-10 mt-5 text-center">
 ...
 <?php 
  $sql = "SELECT * FROM requestlogin_tb"; 
...
<?php
 ...
 $sql = "DELETE FROM requestlogin_tb WHERE r_login_id = {$_REQUEST['id']}";
...
?>
  ...
  <div class="float-right"><a href="insertreq.php" class="btn btn-primary"><i class="fas fa-plus fa-2x"></i></a></div>
 </div> <!-- End Container -->
