...
if(isset($_REQUEST['psubmit'])){
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")){
  ...
  $pid = rand(1000000,9999999);
  $sql = "INSERT INTO assets_tb (pid, pname, pdop, pava, ptotal, poriginalcost, psellingcost) VALUES ('$pid','$pname', '$pdop','$pava', '$ptotal', '$poriginalcost', '$psellingcost')";
