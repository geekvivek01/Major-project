...
<body>
<!-- Top Navbar-->
</nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow"><a class="navbar-brand col-sm-3 
...
<div class="sidebar-sticky">
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link <?php if(PAGE == 'SrviceRequest'){echo 'active';} ?>" href="ServiceRequest.php"><i class="fab fa-accessible-icon"></i>Service Request</a></li>
