...
<div class="myclass mainHeading">
 ...
 <div class="container">
  <div class="jumbotron">
   ...
   <p>
    OSMS Services is India’s leading chain of multi-brand Electronics and Electrical service workshops 
    offering wide array of services. We focus on enhancing your uses experience by offering world-class
    Electronic Appliances maintenance services. Our sole mission is “To provide Electronic Appliances 
    care services to keep the devices fit and healthy and customers happy and smiling”.
    With well-equipped Electronic Appliances service centres and fully trained mechanics, we provide 
    quality services with excellent packages that are designed to offer you great savings.
    Our state-of-art workshops are conveniently located in manycities across the country.
   ...
   <div class="container">
    ...
    <div class="row mt-5">
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        <img src="image/avtar1.jpeg" class="img-fluid" style="border-radius:100px;" alt="avt1">
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        <img src="image/avtar2.jpeg" class="img-fluid" style="border-radius:100px;" alt="avt2">
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        <img src="image/avtar3.jpeg" class="img-fluid" style="border-radius:100px;" alt="avt3">
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 4th Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        <img src="image/avtar4.jpeg" class="img-fluid" style="border-radius:100px;" alt="avt4">
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Vivek kumar poddar &copy; 2022</small>
