<?php 
 ...
 $sql = "SELECT r_name, r_email FROM requestlogin_tb WHERE r_email = '$rEmail'";
 ...
 if(isset($_REQUEST['nameupdate'])){
    if($_REQUEST['rName'] == ""){
     ...
     $sql = "UPDATE requestlogin_tb SET r_name = '$rName' WHERE r_email='$rEmail'";
...
<form action="" method="POST" class="mx-5">
    <div class="form-group">
         ...
         <label for="rEmail">Email</label><input type="text" class="form-control"
