...
if(isset($_REQUEST['rSignup'])){
  ...
  if(($_REQUEST['rName'] == "") || ($_REQUEST["rEmail"] == "") || ($_REQUEST['rPassword'] == "")){
    ...
    $sql = "SELECT r_email FROM requestlogin_tb WHERE r_email ='".$_REQUEST['rEmail']."'";
    ...
    if($result->num_rows==1){
      $regmsg = '<div class="alert alert-warning mt-2" role="alert">Email ID Already Registered</div>';
        ...
        $sql = "INSERT INTO requestlogin_tb(r_name, r_email, r_password) VALUES('$rName', '$rEmail', '$rPassword')";
...
<div class="container pt-5">
    ...
    <div class="form-group">
        ...
        <small class="from-text"> <i>We Will Never Share Your Email With Anyone Else</i></small>
        </div>
        ...
        <em style="font-size:10px;">Note - By clicking Sign Up, you agree to our 
        Terms, Data Policy and Cookie Policy</em>
